import os
from src.config import AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, S3_ROOT
from src.dataset import S3ImageDataset
from src.model import create_resnet, load_checkpoint
from src.train import train_model, validate_model, save_checkpoint
...
if __name__ == "__main__":
    ...
    if os.path.exists(CHECKPOINT_PATH):
        model, _, _, class_to_idx = load_checkpoint(CHECKPOINT_PATH, NUM_CLASSES)
    else:
        # Load dataset
        ...
        save_checkpoint(model, optimizer, epoch, class_to_idx, CHECKPOINT_PATH)
